...
function scrot_full()
	scrot(
		"scrot " .. screenshot .. " -e 'xclip -selection clipboard -t image/png < $f'",
		scrot_callback,
...
function scrot_selection()
	scrot(
		"scrot -s " .. screenshot .. " -e 'xclip -selection clipboard -t image/png < $f'",
		scrot_callback,
...
function scrot_window()
	scrot(
		"scrot -u " .. screenshot .. " -e 'xclip -selection clipboard -t image/png < $f'",
		scrot_callback,
...
function scrot_delay()
	...
	for key, value in ipairs(timers) do
		items[#items + 1] = {
			tostring(value),
			"scrot -d " .. value .. " " .. screenshot .. " -e 'xclip -selection clipboard -t image/png < $f'",
